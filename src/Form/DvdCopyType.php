...
class DvdCopyType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('media', DvdType::class, [
                'label' => false,
            ])
            ...
            ->add('personalNotes', TextareaType::class, [
                'label' => 'Notes personnelles (édition, origine, steelbook...)',
                'required' => false,
                'attr' => [
                    'class' => 'appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm',
                    'placeholder' => 'ex: Boîtier Steelbook collector, version réalisateur...',
                    'rows' => 3
                ],
                'label_attr' => ['class' => 'block text-sm font-medium text-gray-700 mt-4'],
            ])
